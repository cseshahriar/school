<?php
    ...
    if(!empty($_POST)){
      ...
      $imageName = "About-news-".time()."-".rand(1000,100000).".".pathinfo($image['name'], PATHINFO_EXTENSION);
      ...
      if(!empty($title && $details && $image)){
        ...
        if($query){
          move_uploaded_file($image['tmp_name'], 'uploads/'.$imageName);
           $msg = '<span id="message">About Article Update Successfuly</span>';
          header('Location: about-content.php'); //redirect
        }else{
        ...
        <div class="panel-heading">
            <div class="col-md-9 heading_title">
             ...
             <div class="col-md-3 text-right">
                <a href="all-user.php" class="btn btn-sm btn btn-primary" disabled><i class="fa fa-th"></i> About Articel</a>
            </div>
