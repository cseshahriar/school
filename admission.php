     ...
     <section>
      ...
      <section>
            <div class="container">
                ...
                <div class="col-sm-9">
                    <article>
                      <h1>Admission in Scholastica</h1>
                      <p><img src="img/admission.jpg" class="img-responsive" alt="about image">
                       The admissions process in Scholastica is very transparent. Anyone is welcome to apply without any reference. Absolutely no donations are accepted; only published fees are required. </p>
